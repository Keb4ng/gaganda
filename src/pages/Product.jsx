...
const Product = () => {
  ...
  return (
    <div className="max-w-[1200px] mt-[94px] mx-auto min-h-[80vh] h-auto grid grid-cols-1 md:grid-cols-2 gap-5 px-2 my-5">
      ...
      <div className="flex flex-col gap-3 justify-center">
        <div>
          <p className="text-[22px] font-bold text-slate-950">{product.name}</p>
